...
%>
						...
						<tbody>
							<tr>
								...
								<td class="rt_tbl"><input type='text' pattern='[0-9]'
									name='weight' id="n2" placeholder='Enter Weight' required> <input
	...
	<div style="height: 327px !important;"></div>
	<%@include file="all_component/footer.jsp"%>
	<script>
	  function netvalue(){
          rate=parseFloat(document.getElementById("n1").value);
          weight=parseFloat(document.getElementById("n2").value);
          Float netvalue=rate*weight;
              
         document.getElementById("spn").innerHTML=netvalue;
