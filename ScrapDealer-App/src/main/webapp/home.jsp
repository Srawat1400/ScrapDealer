...
<body>
		...
		<section class="hero-section">
			<div class="hero">
				...
				<p>Sell us your recyclable wastes and help contribute to the
					...
					to something new</p>
				<div class="buttons">
					<a href="#ratelist" class="join">Rate List</a> <a href="sell_scrap.jsp"
	...
	<div class="rate_section">
		<div class="row">
			...
			while (rs.next()) {
			%>
			<div class="col-lg-3 col-6 mb-4 pb-4 px-4">
				<div class="container-bg-2 h-100 rounded-4 mt-6 d-flex flex-column">
